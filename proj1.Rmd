...
graph1
```
We plotted the relationship between first two PCs with PC1 as x axis and PC2 as y axis, and we color our points with the value of heights. We find that there is an obvious stratification for our points based on the value of height. Points with smaller values of heights are gathered closely on the top of the graph, while points with larger values of heights are 
